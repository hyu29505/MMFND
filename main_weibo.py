...
parser.add_argument('--dataset', default='weibo', choices=['gossipcop', 'weibo', 'weibo21'], help="要使用的数据集。")
...
parser.add_argument('--lr', type=float, default=0.000175, help="学习率。GossipCop默认为0.0005。weibo21 0.0005 weibo 0.000175") # 将根据dataset调整
...
parser.add_argument('--resume_path', default=None, help="断点续训的 checkpoint 路径（可选）。")
parser.add_argument('--no_resume', action='store_true', help="禁用断点续训，忽略 resume_path 和 last_checkpoint。")
